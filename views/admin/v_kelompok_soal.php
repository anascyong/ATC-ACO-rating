	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="#" id="form">
					<input type="hidden" name="id_kelompok_soal">
					<div class="form-group">
						<label>Kelompok Soal <span class="red">*</span></label>
						<input type="text" name="nama_kelompok" class="form-control" placeholder="Kelompok Soal">
